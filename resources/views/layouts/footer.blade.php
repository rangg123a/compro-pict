<footer class="footer bg-blue-950 text-white mt-16 md:mt-20 border-t-4 border-red-600">
    <div class="max-w-7xl mx-auto px-6 py-12 md:py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8 lg:gap-12">
            
            <!-- Company Info -->
            <div class="space-y-4 sm:col-span-2 lg:col-span-1">
                <div class="flex items-center gap-3 shrink-0 mb-4 md:mb-6">
                    <img src="{{ asset('assets/images/pict.png') }}" alt="PICT Logo" class="h-10 md:h-12 w-auto object-contain bg-white p-1 rounded">
                    <div>
                        <h4 class="font-bold text-white tracking-wide text-sm leading-tight">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm text-blue-200">
                    <li class="flex items-start gap-3">
                        ...
                        <span>Patimban Port, Pusakanagara,<br>Subang, West Java, Indonesia</span>
                    </li>
    ...
    <div class="border-t border-blue-900 bg-blue-950">
        <div class="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-blue-300 text-center md:text-left">
            <p>&copy; {{ date('Y') }} PT Patimban International Car Terminal. All Rights Reserved.</p>
