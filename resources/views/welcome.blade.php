...
<style>
    ...
    /* ═══ HYPERSPEED LIGHT RAYS CONTAINER ═══ */
    #lights {
        position: absolute;
        inset: 0;
        width: 100%;
    ...
    .stats-strip.is-visible .stat-item:nth-child(2) { transition-delay: .1s; }
    .stats-strip.is-visible .stat-item:nth-child(3) { transition-delay: .2s; }
    .stats-strip.is-visible .stat-item:nth-child(4) { transition-delay: .3s; }
...
<!-- ═══ 1. HERO SECTION (PERSPECTIVE HYPERSPEED HIGHWAY) ═══ -->
<div class="relative w-full min-h-[88vh] flex items-center overflow-hidden border-b border-white/10 bg-slate-950 pt-[env(safe-area-inset-top)]">
    ...
    <div class="absolute inset-0 bg-gradient-to-r from-slate-950 via-slate-950/85 to-transparent z-2 pointer-events-none"></div>
            ...
            <div class="lg:col-span-5 flex justify-center lg:justify-end items-center">
                <div class="w-full max-w-md backdrop-blur-[2px] p-2 rounded-2xl">
                    <svg class="w-full h-auto drop-shadow-[0_20px_35px_rgba(0,0,0,0.6)]" viewBox="0 0 420 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <!-- Template Icon 1: Passenger Vehicle (CBU) -->
                            <g id="heroCar1">
                                <path d="M10 40H90V45H10V40Z" fill="#38bdf8"/>
                                <circle cx="25" cy="45" r="7" fill="none" stroke="#ffffff" stroke-width="4"/>
                                <circle cx="75" cy="45" r="7" fill="none" stroke="#ffffff" stroke-width="4"/>
                                <path d="M20 40L30 20H70L80 40H20Z" fill="none" stroke="#dc2626" stroke-width="5" stroke-linejoin="round"/>
                            </g>
                            <!-- Template Icon 2: Commercial Truck -->
                            <g id="heroCar2">
                                <path d="M10 42H90V46H10V42Z" fill="#38bdf8"/>
                                <circle cx="25" cy="46" r="6" fill="none" stroke="#ffffff" stroke-width="3"/>
                                <circle cx="45" cy="46" r="6" fill="none" stroke="#ffffff" stroke-width="3"/>
                                <circle cx="80" cy="46" r="6" fill="none" stroke="#ffffff" stroke-width="3"/>
                            ...
                            <!-- Template Icon 3: Heavy Equipment -->
                            <g id="heroCar3">
                                <path d="M15 42H85V46H15V42Z" fill="#38bdf8"/>
                                <circle cx="30" cy="46" r="7" fill="none" stroke="#ffffff" stroke-width="4"/>
                                <circle cx="70" cy="46" r="7" fill="none" stroke="#ffffff" stroke-width="4"/>
...
<!-- ═══ 7. INTERNATIONAL & DOMESTIC SHIPPING ROUTE NETWORK ═══ -->
<section class="py-20 bg-blue-950 relative overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 pb-4 border-b border-white/10 gap-4">
            <div>
                <h2 class="text-3xl sm:text-4xl font-extrabold text-white mt-1">Shipping Route Network</h2>
            </div>
        ...
        </div>    <div class="bg-white/5 border border-white/10 rounded-2xl p-2 sm:p-6 backdrop-blur-sm">
        ...
        <div class="overflow-x-auto no-scrollbar snap-x snap-mandatory rounded-xl -mx-2 px-2 sm:mx-0 sm:px-0 pb-4">
            <div class="min-w-[700px] md:min-w-0">
                <svg id="routeMapSvg" class="w-full h-auto touch-manipulation snap-center" viewBox="0 0 900 460" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- DOMESTIC ROUTES (Blue Color #38bdf8) -->
                    <!-- Route: Patimban -> Pontianak -->
                    <path class="route-hit" data-route="domestic" d="M268 416 Q 240 370 220 330" stroke="transparent" stroke-width="18" fill="none" pointer-events="stroke" />
                    <path id="rutePatPontianak" class="route-line" data-route="domestic" d="M268 416 Q 240 370 220 330" stroke="#38bdf8" stroke-width="1.6" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                    <g class="route-marker" data-route="domestic" fill="#38bdf8">
                        <use href="#shipIcon" />
                    ...
                    <path id="rutePatBatam" class="route-line" data-route="domestic" d="M268 416 Q 210 390 170 340" stroke="#38bdf8" stroke-width="1.6" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                    <g class="route-marker" data-route="domestic" fill="#38bdf8">
                        <use href="#shipIcon" />
                    ...
                    <path id="rutePatBelawan" class="route-line" data-route="domestic" d="M268 416 Q 160 380 90 310" stroke="#38bdf8" stroke-width="1.6" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                    <g class="route-marker" data-route="domestic" fill="#38bdf8">
                        <use href="#shipIcon" />
                    ...
                    <path id="rutePatBanjarmasin" class="route-line" data-route="domestic" d="M268 416 Q 330 380 390 350" stroke="#38bdf8" stroke-width="1.6" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                    <g class="route-marker" data-route="domestic" fill="#38bdf8">
                        <use href="#shipIcon" />
                        <animateMotion dur="3.8s" repeatCount="indefinite" rotate="auto">
                            <mpath href="#rutePatBanjarmasin"/>
                        </animateMotion>
                    </g>


                    <!-- INTERNATIONAL ROUTES (Yellow Color #facc15) -->
                    <!-- Route: Patimban -> Port Klang & Laem Chabang -->
                    ...
                    <path id="ruteIntKlangChabang" class="route-line" data-route="international" d="M268 416 Q 200 320 140 250" stroke="#facc15" stroke-width="1.6" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                    <g class="route-marker" data-route="international" fill="#facc15">
                        <use href="#shipIcon" />
                        <animateMotion dur="6s" repeatCount="indefinite" rotate="auto">
                            <mpath href="#ruteIntKlangChabang"/>
                        </animateMotion>
                    </g>

                    <!-- Route: Patimban -> Hong Kong & Guangzhou -->
                    ...
                    <path id="ruteIntHKGZ" class="route-line" data-route="international" d="M268 416 Q 350 250 472 129" stroke="#facc15" stroke-width="1.6" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                    <g class="route-marker" data-route="international" fill="#facc15">
                        <use href="#shipIcon" />
                        <animateMotion dur="7.5s" repeatCount="indefinite" rotate="auto">
                            <mpath href="#ruteIntHKGZ"/>
                        </animateMotion>
                    </g>

                    <!-- Route: Patimban -> Japan Hubs (Nagoya, Yokohama, Osaka, Tahara) -->
                    ...
                    <path id="ruteIntJapan" class="route-line" data-route="international" d="M268 416 Q 480 260 745 95" stroke="#facc15" stroke-width="1.6" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                    <g class="route-marker" data-route="international" fill="#facc15">
                        <use href="#shipIcon" />
                        <animateMotion dur="9s" repeatCount="indefinite" rotate="auto">
                            <mpath href="#ruteIntJapan"/>
                        </animateMotion>
                    </g>

                    <!-- Route: Patimban -> Regional Hubs (Batangas, Muara, Singapore) -->
                    ...
                    <path id="ruteIntRegional" class="route-line" data-route="international" d="M275 420 Q 420 380 580 320" stroke="#facc15" stroke-width="1.6" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                    <g class="route-marker" data-route="international" fill="#facc15">
                        <use href="#shipIcon" />
                        <animateMotion dur="7s" repeatCount="indefinite" rotate="auto">
                            <mpath href="#ruteIntRegional"/>
                        </animateMotion>
                    </g>

                    <!-- Destination Port Markers -->
                    <g class="dest-marker" data-route="domestic" tabindex="0" role="button" aria-label="View Domestic route details"><circle cx="220" cy="330" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="220" cy="330" r="4" fill="#38bdf8" stroke="#ffffff" stroke-width="1" /></g>
                    <g class="dest-marker" data-route="domestic" tabindex="0" role="button" aria-label="View Domestic route details"><circle cx="170" cy="340" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="170" cy="340" r="4" fill="#38bdf8" stroke="#ffffff" stroke-width="1" /></g>
                    <g class="dest-marker" data-route="domestic" tabindex="0" role="button" aria-label="View Domestic route details"><circle cx="90" cy="310" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="90" cy="310" r="4" fill="#38bdf8" stroke="#ffffff" stroke-width="1" /></g>
                    <g class="dest-marker" data-route="domestic" tabindex="0" role="button" aria-label="View Domestic route details"><circle cx="390" cy="350" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="390" cy="350" r="4" fill="#38bdf8" stroke="#ffffff" stroke-width="1" /></g>

                    <g class="dest-marker" data-route="international" tabindex="0" role="button" aria-label="View International route details"><circle cx="140" cy="250" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="140" cy="250" r="4" fill="#facc15" stroke="#ffffff" stroke-width="1" /></g>
                    <g class="dest-marker" data-route="international" tabindex="0" role="button" aria-label="View International route details"><circle cx="472" cy="129" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="472" cy="129" r="4" fill="#facc15" stroke="#ffffff" stroke-width="1" /></g>
                    <g class="dest-marker" data-route="international" tabindex="0" role="button" aria-label="View International route details"><circle cx="745" cy="95" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="745" cy="95" r="4" fill="#facc15" stroke="#ffffff" stroke-width="1" /></g>
                    <g class="dest-marker" data-route="international" tabindex="0" role="button" aria-label="View International route details"><circle cx="580" cy="320" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="580" cy="320" r="4" fill="#facc15" stroke="#ffffff" stroke-width="1" /></g>
        ...
        <div id="routeLegend" class="flex flex-wrap gap-2 justify-center mt-2 sm:mt-6 pt-3 sm:pt-5 border-t border-white/10">
            <button type="button" data-route="all" class="route-legend-btn is-active flex items-center gap-2 text-xs font-semibold text-slate-300 rounded-full px-3 py-2 hover:bg-white/10 transition"><span class="w-2.5 h-2.5 rounded-full bg-red-600 inline-block"></span>All Routes</button>
            <button type="button" data-route="international" class="route-legend-btn flex items-center gap-2 text-xs font-semibold text-slate-300 rounded-full px-3 py-2 hover:bg-white/10 transition"><span class="w-2.5 h-2.5 rounded-full bg-yellow-400 inline-block"></span>International</button>
            <button type="button" data-route="domestic" class="route-legend-btn flex items-center gap-2 text-xs font-semibold text-slate-300 rounded-full px-3 py-2 hover:bg-white/10 transition"><span class="w-2.5 h-2.5 rounded-full bg-sky-400 inline-block"></span>Domestic</button>
        </div>
        ...
        <div id="routeInfoPanel" class="mt-4 rounded-xl border-l-4 border-red-600 bg-white/5 px-4 py-3 text-sm text-slate-200 leading-relaxed transition-colors">
            <p id="routeInfoTitle" class="font-bold text-white mb-0.5">Patimban Port Network</p>
            <p id="routeInfoDesc">Pilih kategori rute untuk melihat jaringan pelayaran dari Patimban Port.</p>
            <div class="mt-3 grid gap-2 sm:grid-cols-2" aria-label="Route details">
                <div class="rounded-lg border border-yellow-400/30 bg-yellow-400/10 px-3 py-2">
                    <p class="font-bold text-yellow-300">International Routes</p>
                    <p class="mt-1 text-xs text-slate-300 leading-relaxed">
                        <span class="font-semibold text-yellow-300">Export:</span> Port Klang, Laem Chabang, Hong Kong, Guangzhou, Nagoya, Yokohama, dan Osaka.
                        <span class="font-semibold text-yellow-300"> Import:</span> Tahara, Batangas, Muara, dan Singapore.
                    </p>
                </div>
                <div class="rounded-lg border border-sky-400/30 bg-sky-400/10 px-3 py-2">
                    <p class="font-bold text-sky-300">Domestic Routes</p>
                    <p class="mt-1 text-xs text-slate-300 leading-relaxed">
                        Layanan feeder domestik dari Patimban menuju Pontianak, Batam, Belawan, dan Banjarmasin.
                    </p>
                </div>
            </div>
        </div>
...
<section class="py-20 bg-slate-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        </div>    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
