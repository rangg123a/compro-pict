            ...
            <div class="lg:col-span-5 flex justify-center lg:justify-end items-center">
                <div class="w-full max-w-md backdrop-blur-[2px] p-2 rounded-2xl">
                    <svg class="w-full h-auto drop-shadow-[0_20px_35px_rgba(0,0,0,0.6)]" viewBox="0 0 420 300" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <g id="carRed">
                                <path d="M5 22L11 12.5C12.2 10.6 14.2 9.5 16.5 9.5H37.5C40 9.5 42.1 10.7 43.3 12.9L48 22H54C56.2 22 58 23.8 58 26V29H2V26C2 23.8 3.8 22 5 22Z" fill="#dc2626" stroke="#fecaca" stroke-width="1" />
                                <path d="M14 12.5H23L22 20H9.5L13.4 13.5C13.5 13.1 13.7 12.8 14 12.5Z" fill="#bae6fd" stroke="#eff6ff" stroke-width=".8" />
                                <path d="M25 12.5H37C38.2 12.5 39.2 13.1 39.8 14.1L43 20H24L25 12.5Z" fill="#7dd3fc" stroke="#eff6ff" stroke-width=".8" />
                                <path d="M47 21H52L54 23.5H48.5L47 21Z" fill="#fef08a" />
                                <path d="M3 22H8L6.5 24H3.5L3 22Z" fill="#fef08a" />
                                <circle cx="14" cy="29" r="5" fill="#0f172a" /><circle cx="14" cy="29" r="2.3" fill="#94a3b8" />
                                <circle cx="45" cy="29" r="5" fill="#0f172a" /><circle cx="45" cy="29" r="2.3" fill="#94a3b8" />
                            </g>
                            <g id="carSilver">
                                <use href="#carRed" fill="#cbd5e1" />
                                <path d="M5 22L11 12.5C12.2 10.6 14.2 9.5 16.5 9.5H37.5C40 9.5 42.1 10.7 43.3 12.9L48 22H54C56.2 22 58 23.8 58 26V29H2V26C2 23.8 3.8 22 5 22Z" fill="#e2e8f0" stroke="#ffffff" stroke-width="1" />
                                <path d="M14 12.5H23L22 20H9.5L13.4 13.5C13.5 13.1 13.7 12.8 14 12.5Z" fill="#bae6fd" /><path d="M25 12.5H37C38.2 12.5 39.2 13.1 39.8 14.1L43 20H24L25 12.5Z" fill="#7dd3fc" />
                            </g>
                            <g id="carBlue">
                                <use href="#carRed" />
                                <path d="M5 22L11 12.5C12.2 10.6 14.2 9.5 16.5 9.5H37.5C40 9.5 42.1 10.7 43.3 12.9L48 22H54C56.2 22 58 23.8 58 26V29H2V26C2 23.8 3.8 22 5 22Z" fill="#1e3a8a" stroke="#bfdbfe" stroke-width="1" />
                                <path d="M14 12.5H23L22 20H9.5L13.4 13.5C13.5 13.1 13.7 12.8 14 12.5Z" fill="#bae6fd" /><path d="M25 12.5H37C38.2 12.5 39.2 13.1 39.8 14.1L43 20H24L25 12.5Z" fill="#7dd3fc" />
                            </g>
                        </defs>
                        ...
                        <g class="cargo-row-bottom" opacity="0.95">
                            <use href="#carRed" transform="translate(18 190) scale(.9)" />
                            <use href="#carSilver" transform="translate(81 190) scale(.9)" />
                            <use href="#carBlue" transform="translate(144 190) scale(.9)" />
                            <use href="#carRed" transform="translate(207 190) scale(.9)" />
                            <use href="#carSilver" transform="translate(270 190) scale(.9)" />
                            <use href="#carBlue" transform="translate(333 190) scale(.9)" />
                        </g>

                        <g class="cargo-row-top" opacity="0.85">
                            <use href="#carSilver" transform="translate(48 152) scale(.82)" />
                            <use href="#carBlue" transform="translate(108 152) scale(.82)" />
                            <use href="#carRed" transform="translate(168 152) scale(.82)" />
                            <use href="#carSilver" transform="translate(228 152) scale(.82)" />
                            <use href="#carBlue" transform="translate(288 152) scale(.82)" />
                        </g>
                    </svg>
                </div>
            </div>
