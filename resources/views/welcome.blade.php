    ...
    <g transform="translate(11,7) scale(0.35)">
        ...
        <path d="M-6,2 C-6,-2 6,-2 6,2 C6,5 -6,5 -6,2 Z" fill="#cc0000"/>
                        ...
                        <g clip-path="url(#mapClip)">
                            ...
                            <!-- Daratan Thailand, Indochina, Semenanjung Malaysia, dan Singapura yang lebih natural -->
                            <path d="M 50 140 L 75 145 L 90 155 L 110 180 L 125 210 L 135 240 L 140 270 L 145 305 L 150 330 L 135 320 L 120 290 L 110 260 L 95 220 L 80 190 L 65 170 Z" fill="#dcfce7" stroke="#86efac" stroke-width="0.8" stroke-opacity="0.8" />
                                                        <!-- Filipina (Area Batangas / Luzon) -->
                            <path d="M 565 290 L 585 295 L 595 315 L 590 335 L 570 340 L 555 325 L 558 300 Z" fill="#dcfce7" stroke="#86efac" stroke-width="0.8" stroke-opacity="0.8" />
                                                        <!-- Jepang (Area Nagoya/Yokohama/Osaka) -->
                            <path d="M 720 50 L 745 55 L 755 75 L 760 100 L 750 125 L 730 135 L 715 115 L 720 85 L 725 65 Z" fill="#dcfce7" stroke="#86efac" stroke-width="0.8" stroke-opacity="0.8" />                       
                            <text x="80" y="170" fill="#475569" font-size="10" font-weight="700" letter-spacing="1">THAILAND</text>
                            ...
                            <text x="445" y="320" fill="#475569" font-size="10" font-weight="700" letter-spacing="1">Brunei</text>
                             <text x="55" y="250" fill="#475569" font-size="10" font-weight="700" letter-spacing="1">MALAYSIA</text>

                         <text x="60" y="290" fill="#475569" font-size="10" font-weight="700" letter-spacing="1">SINGAPURA</text>
                        ...
                        <g class="dest-marker" data-route="international" tabindex="0" role="button">
                            ...
                            <path class="route-hit" data-route="domestic" d="M268 416 Q 320 400 380 380" stroke="transparent" stroke-width="18" fill="none" pointer-events="stroke" />

                            <!-- 2. Garis Putus-putus Rute yang Ujungnya Menempel ke Dot (380, 380) -->
                            <path id="rutePatBanjarmasin" class="route-line" data-route="domestic" d="M268 416 Q 320 400 380 380" stroke="#0284c7" stroke-width="1.8" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />

                            <!-- 3. Animasi Kapal di Rute Banjarmasin -->
                            ...
                            <!-- internationalRoutes -->
                            <!-- Garis Hit / Interaktif -->
                            <path class="route-hit" data-route="international" d="M268 416 Q 200 280 140 165" stroke="transparent" stroke-width="18" fill="none" pointer-events="stroke" />

                            <!-- Garis Putus-putus Rute -->
                            <path id="ruteIntKlangChabang" class="route-line" data-route="international" d="M268 416 Q 200 280 140 165" stroke="#d97706" stroke-width="1.8" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" /> 
                            ...
                            <!-- Rute ke Brunei Darussalam -->
                            <path class="route-hit" data-route="international" d="M268 416 Q 350 380 430 335" stroke="transparent" stroke-width="18" fill="none" pointer-events="stroke" />
                            <path id="ruteIntBrunei" class="route-line" data-route="international" d="M268 416 Q 350 380 430 335" stroke="#d97706" stroke-width="1.8" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                            <g class="route-marker" data-route="international" fill="#d97706">
                                <use href="#shipIcon" />
                                <animateMotion dur="5.5s" repeatCount="indefinite" rotate="auto">
                                    <mpath href="#ruteIntBrunei"/>
                                </animateMotion>
                            </g>
                                                        ...
                                                        <g class="dest-marker" data-route="domestic" tabindex="0" role="button"><circle cx="300" cy="330" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="300" cy="370" r="4" fill="#0284c7" stroke="#ffffff" stroke-width="1" /><text x="300" y="360" fill="#006aff" font-size="10" font-weight="700" letter-spacing="1">Pontianak</text></g> // Rute ke Pontianak (Menuju titik 300, 370)
                                                        <g class="dest-marker" data-route="domestic" tabindex="0" role="button"><circle cx="180" cy="350" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="180" cy="350" r="4" fill="#0284c7" stroke="#ffffff" stroke-width="1" /><text x="160" y="340" fill="#006aff" font-size="10" font-weight="700" letter-spacing="1">Batam</text></g> // Rute ke Batam (Menuju titik 180, 350)
                                                        <g class="dest-marker" data-route="domestic" tabindex="0" role="button"><circle cx="110" cy="320" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="110" cy="320" r="4" fill="#0284c7" stroke="#ffffff" stroke-width="1" /><text x="80" y="310" fill="#006aff" font-size="10" font-weight="700" letter-spacing="1">Belawan</text></g> // Rute ke Belawan (Menuju titik 110, 320)
                                                        <g class="dest-marker" data-route="domestic" tabindex="0" role="button"><circle cx="400" cy="380" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="380" cy="380" r="4" fill="#0284c7" stroke="#ffffff" stroke-width="1" /><text x="400" y="380" fill="#006aff" font-size="10" font-weight="700" letter-spacing="1">Banjarmasin</text></g> // Rute ke Banjarmasin (Menuju titik 380, 380)

                                                        <g class="dest-marker" data-route="international" tabindex="0" role="button"><circle cx="140" cy="250" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="140" cy="170" r="4" fill="#d97706" stroke="#ffffff" stroke-width="1" /><use href="#flag-th" x="150" y="160" /></g> // Rute ke Thailand (Menuju titik 140, 170)
                                                        <g class="dest-marker" data-route="international" tabindex="0" role="button"><circle cx="150" cy="330" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="120" cy="250" r="4" fill="#d97706" stroke="#ffffff" stroke-width="1" /><use href="#flag-my" x="130" y="245" /></g> // Rute ke Malaysia (Menuju titik 120, 250)

                         <path class="route-hit" data-route="international" d="M268 416 Q 200 330 130 250" stroke="transparent" stroke-width="18" fill="none" pointer-events="stroke" />
<path id="ruteIntMalaysia" class="route-line" data-route="international" d="M268 416 Q 200 330 130 250" stroke="#d97706" stroke-width="1.8" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
<g class="route-marker" data-route="international" fill="#d97706">
    <use href="#shipIcon" />
    <animateMotion dur="5.5s" repeatCount="indefinite" rotate="auto">
        <mpath href="#ruteIntMalaysia"/>
                                                        ...
                                                        <g class="dest-marker" data-route="international" tabindex="0" role="button"><circle cx="165" cy="305" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="140" cy="305" r="4" fill="#d97706" stroke="#ffffff" stroke-width="1" /><use href="#flag-sg" x="154" y="281" /></g>
                            <!-- Rute Singapura (Menuju titik 135, 305) -->
                            <path class="route-hit" data-route="international" d="M268 416 Q 200 360 135 305" stroke="transparent" stroke-width="18" fill="none" pointer-events="stroke" />
                            <path id="ruteIntSingapore" class="route-line" data-route="international" d="M268 416 Q 200 360 135 305" stroke="#d97706" stroke-width="1.8" stroke-dasharray="4 5" fill="none" opacity="0.85" pointer-events="none" />
                            <g class="route-marker" data-route="international" fill="#d97706">
                                <use href="#shipIcon" />
                                <animateMotion dur="5s" repeatCount="indefinite" rotate="auto">
                                    <mpath href="#ruteIntSingapore"/>
                                                        ...
                                                        <g class="dest-marker" data-route="international" tabindex="0" role="button"><circle cx="472" cy="129" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="472" cy="129" r="4" fill="#d97706" stroke="#ffffff" stroke-width="1" /><use href="#flag-cn" x="462" y="109" /></g> // Rute ke China (Menuju titik 472, 129)
                                                        <g class="dest-marker" data-route="international" tabindex="0" role="button"><circle cx="745" cy="95" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="745" cy="95" r="4" fill="#d97706" stroke="#ffffff" stroke-width="1" /><use href="#flag-jp" x="735" y="75" /></g> // Rute ke Jepang (Menuju titik 745, 95)
                                                        <g class="dest-marker" data-route="international" tabindex="0" role="button"><circle cx="580" cy="320" r="14" fill="transparent" pointer-events="all" /><circle class="visible-dot" cx="580" cy="320" r="4" fill="#d97706" stroke="#ffffff" stroke-width="1" /><use href="#flag-ph" x="570" y="300" /><text x="600" y="310" fill="#473f3a" font-size="10" font-weight="700" letter-spacing="1">Philippines (Batangas)</text></g> // Rute ke Filipina (Menuju titik 580, 320)
                                    ...
                                    <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                                        ...
                                        <div class="lg:col-span-2 grid sm:grid-cols-2 lg:grid-cols-1 gap-6" data-aos="fade-left">
                                            ...
                                            <div class="rounded-2xl bg-blue-950 p-6 text-white shadow-sm">
                                                ...
                                                <p class="mt-2 text-sm leading-relaxed text-slate-300">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
